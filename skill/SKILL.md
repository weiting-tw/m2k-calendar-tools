...
| 模糊人名查 email（「把 pekka 加進會議」） | MCP 工具：`find_person`（行事曆歷史與會者；設定 M2K_COOKIE/M2K_SSNID 後可搜全公司通訊錄） |
...
- 建立會議：`python3 src/m2kcal.py book --title "週會" --start "2026-07-10 14:00" --end "2026-07-10 15:00" [--location ...] [--attendee a@example.com]`
