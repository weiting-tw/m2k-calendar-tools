...
async def test_stdio():
    params = StdioServerParameters(
        ...
        env={**os.environ, "M2K_USER": "fake@gss.com.tw", "M2K_PASS": "x"})
    async with stdio_client(params) as (r, w):
        async with ClientSession(r, w) as s:
            ...
            assert ui_tools["calendar_data"]["resourceUri"] == "ui://m2k-calendar/calendar.html"
...
async def test_http(url):
    ...
    hdr = {"Authorization": "Basic " + base64.b64encode(b"fake@gss.com.tw:wrongpass").decode()}
